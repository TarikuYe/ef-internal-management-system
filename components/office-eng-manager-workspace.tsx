...
export function OfficeEngManagerWorkspace({
  ...
  const executeDeleteRecord = async (id: number | string, tab: string) => {
    const endpoints: any = { projects: '/api/projects', evaluations: '/api/evaluations', weeklyTasks: '/api/weekly-tasks' }
    const mutators: any = { projects: mutateProjects, evaluations: mutateEvals, weeklyTasks: mutateWeeklyTasks }
